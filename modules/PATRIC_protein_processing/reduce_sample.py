...
class ReduceSample(Task):
    ...
    def __init__(self, fasta_pathname="./proteins.fasta", 
        ...
        super().__init__()
        #self.__proteins_pathname = fasta_pathname # Es necesario almacenar la ruta a las proteínas porque si no no se puede recuperar la tarea desde un archivo json
