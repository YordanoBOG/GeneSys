...
This module contains the main classes that might be employed by all GeneSys modules, such as the
abstract class that defines a task or the workflow management class
"""
